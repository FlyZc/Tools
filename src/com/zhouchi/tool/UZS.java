...
public class UZS {
    public static void main(String[] args) throws Exception {
        ...
        //读取需统计用户的数据
        InputStream streamUser = new FileInputStream("G:\\UserUZS.xlsx");
        ...
        //读取通信记录表的内容
        InputStream stream = new FileInputStream("G:\\UZS.xlsx");
        ...
        File file = new File("G:\\UZS.txt");
        try(FileOutputStream outputStream = new FileOutputStream(file);
            OutputStreamWriter streamWriter = new OutputStreamWriter(outputStream)) {
            streamWriter.write("========================UZS========================\n");
