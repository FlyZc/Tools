...
public class TD32 {
    public static void main(String[] args) throws Exception {
        ...
        //读取需统计用户的数据
        InputStream streamUser = new FileInputStream("E:\\Daily\\TD32.xlsx");
        if (streamUser == null) {
            streamWriterInfo.append("TD32全网通话记录<TD32.xlsx>不存在或文件命名错误，请核实！！！\n");
            return;
        }
        ...
        //读取TD32 DH方向用户的数据
        InputStream streamUserDH = new FileInputStream("E:\\Daily\\TDDH32.xlsx");
        if (streamUserDH == null) {
            streamWriterInfo.append("TD32 DH方向用户名单<TDDH32.xlsx>不存在或文件命名错误，请核实！！！\n");
            return;
        }
        ...
        //读取TD32 NH方向用户的数据
        InputStream streamUserNH = new FileInputStream("E:\\Daily\\TDNH32.xlsx");
        if (streamUserNH == null) {
            streamWriterInfo.append("TD32 NH方向用户名单<TDNH32.xlsx>不存在或文件命名错误，请核实！！！\n");
            return;
        }
        ...
        //读取TD32 NH方向用户的数据
        InputStream streamUserTH = new FileInputStream("E:\\Daily\\TDTH32.xlsx");
        if (streamUserTH == null) {
            streamWriterInfo.append("TD32 TH方向用户名单<TDTH32.xlsx>不存在或文件命名错误，请核实！！！\n");
            return;
        }
        ...
        //读取TD32 ZYZDGZ方向用户的数据
        InputStream streamUserZYZDGZ = new FileInputStream("E:\\Daily\\TDZYZDGZ32.xlsx");
        ...
        File fileAll = new File("E:\\Daily\\TD32.txt");
        File fileDH = new File("E:\\Daily\\TDDH32.txt");
        File fileTH = new File("E:\\Daily\\TDTH32.txt");
        File fileNH = new File("E:\\Daily\\TDNH32.txt");
        File fileZYZDGZ = new File("E:\\Daily\\TDZYZDGZ32.txt");
        ...
        //获取所有通信用户站列表;
        String path = "E:\\Daily\\TD32.xlsx";

        calAllRate(path, userAll,fileAll,"TD32全网呼通率统计");
        calIRate(path, userAll, userDH, userDHResult, fileDH,"TD32 DH方向呼通率统计");
        calIRate(path, userAll, userNH, userNHResult, fileNH,"TD32 NH方向呼通率统计");
        calIRate(path, userAll, userTH, userTHResult, fileTH,"TD32 TH方向呼通率统计");
        calIRate(path, userAll, userZYZDGZ, userZYZDGZResult, fileZYZDGZ, "32网 ZYZDGZ呼通率统计");
    }
                    ...
                    if (callAddress == null) {
                        ...
                        if (user.contains(callAddress.toString())) {
                            if (("成功".equals(result.toString()))) {
                                ...
                                System.out.println("32 " + callAddress.toString());
                                successCount++;
                            }
                        }
                    }
